...
Both variants now carry Lane C — ACP dispatch via an embedded `acp-run.mjs` bridge (Grok defaults to it; Claude can use it in the Cursor variant; Codex waits on a newer `codex-acp`).
